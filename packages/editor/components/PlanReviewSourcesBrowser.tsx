...
export function PlanReviewSourcesBrowser({
  ...
  return <>
    ...
    <div className="flex h-10 items-center justify-between border-b border-border/50 px-3"><span className="text-xs font-medium">Ex-Plannotator Plan</span><button type="button" onClick={onMobileClose} className="inline-flex items-center gap-1 rounded px-2 py-1 text-xs font-medium text-muted-foreground hover:bg-muted hover:text-foreground lg:hidden" aria-label="Close reviewed sources"><span aria-hidden="true">×</span>Close</button></div>
